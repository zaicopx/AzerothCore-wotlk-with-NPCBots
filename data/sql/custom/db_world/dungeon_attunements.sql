...
REPLACE INTO `dungeon_access_requirements` (`dungeon_access_id`, `requirement_type`, `requirement_id`, `requirement_note`, `faction`, `priority`, `leader_only`, `comment`) VALUES (32, 1, 10445, 'Du musst die Quest "Die Phiolen der Ewigkeit" abschliessen und Level 70 erreichen, bevor du diese Instanz betreten kannst.', 2, NULL, 0, NULL);
REPLACE INTO `dungeon_access_requirements` (`dungeon_access_id`, `requirement_type`, `requirement_id`, `requirement_note`, `faction`, `priority`, `leader_only`, `comment`) VALUES (46, 1, 10901, 'Du musst die Quest "Der Knüppel von Kar\'desh" abschliessen und Level 70 erreichen, bevor du diese Instanz betreten kannst.', 2, NULL, 0, NULL);
REPLACE INTO `dungeon_access_requirements` (`dungeon_access_id`, `requirement_type`, `requirement_id`, `requirement_note`, `faction`, `priority`, `leader_only`, `comment`) VALUES (47, 2, 31704, 'Du musst den Schlüssel der Stürme besitzen, um das Auge zu betreten.', 2, NULL, 0, NULL);
REPLACE INTO `dungeon_access_requirements` (`dungeon_access_id`, `requirement_type`, `requirement_id`, `requirement_note`, `faction`, `priority`, `leader_only`, `comment`) VALUES (47, 1, 10888, 'Du musst die Quest "Die Prüfung der Naaru: Magtheridon" abschliessen, um das Auge zu betreten.', 2, NULL, 0, NULL);
REPLACE INTO `dungeon_access_requirements` (`dungeon_access_id`, `requirement_type`, `requirement_id`, `requirement_note`, `faction`, `priority`, `leader_only`, `comment`) VALUES (62, 1, 10277, 'Du musst die Quest "Die Höhlen der Zeit" abschliessen, um die alten Hügellande zu betreten.', 2, NULL, 0, NULL);
REPLACE INTO `dungeon_access_requirements` (`dungeon_access_id`, `requirement_type`, `requirement_id`, `requirement_note`, `faction`, `priority`, `leader_only`, `comment`) VALUES (63, 1, 10277, 'Du musst die Quest "Die Höhlen der Zeit" abschliessen, um die alten Hügellande zu betreten.', 2, NULL, 0, NULL);
REPLACE INTO `dungeon_access_requirements` (`dungeon_access_id`, `requirement_type`, `requirement_id`, `requirement_note`, `faction`, `priority`, `leader_only`, `comment`) VALUES (64, 2, 32649, 'Du musst das Medaillon von Karabor besitzen, um den schwarzen Tempel zu betreten.', 2, NULL, 0, NULL);
